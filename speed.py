...
model=YOLOmodel = YOLO(r'C:\Users\Lenovo\Desktop\object detection\yolov8s.pt')
import csv
...
log_file = open('object_log.csv', 'w', newline='')
csv_writer = csv.writer(log_file)
csv_writer.writerow(['Timestamp', 'ObjectID', 'X', 'Y', 'Speed(km/h)'])
